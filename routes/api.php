...
Route::group(['middleware' => 'auth:api'], function () {
    ...
    Route::post('message/store', 'MessageController@store'); //保存班级留言
...
# 个人中心
    ...
    Route::get('users/preNext', 'UserController@preNext'); //上一张和下一张图片

    Route::post('users/uploadHead', 'UserController@uploadHead'); //上传头像
    Route::post('users/uploadBack', 'UserController@uploadBack'); //上传背景图
    Route::post('users/uploadMyPicture', 'UserController@uploadMyPicture'); //上传图片到个人相册
    Route::post('users/update', 'UserController@update'); //更改个人信息
